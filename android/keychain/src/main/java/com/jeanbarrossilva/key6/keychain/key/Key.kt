...
class Key
  internal constructor(
    ...
    companion object {
      ...
      internal fun validateAndNormalize(
        title: String,
        login: String
...
sealed class KeyException(
   ...
   */
  class NonUuidV7ID internal constructor(
    val version: Int?
  ) : KeyException(
   ...
   */
  class Non16ByteSalt internal constructor(
    val size: Int
   ...
   */
  class Non12ByteIV internal constructor(
    val size: Int
